  ...
  return (
    <div className="w-full flex px-14 py-20 flex-col bg-gradient-to-br from-white via-slate-50 bg-teal-50">
      ...
      <div className="py-10 flex flex-row gap-3">
        <div className="w-1/3 flex flex-col justify-between bg-white shadow-sm rounded p-8">
          <div>
        ...
        <div className="w-1/3 flex flex-col justify-between shadow-sm bg-white rounded p-8">
          <div>
            <FaQuoteLeft className="text-green-800 my-2" />
            <p className="font-light text-sm">
