    ...
    <div className={`flex w-full flex-col ${montserrat.className}`}>
      ...
      <div className="px-14 relative border-b ServicesHeight w-full py-20">
        ...
        <div className="absolute px-4 md:px-14 gap-1 w-full md:w-1/2 justify-center inset-0 flex-col flex">
          ...
          <p className="md:font-light py-1 font-normal text-gray-100 md:text-black">
            ...
            specific needs. Don&apos;t let termites disrupt your life any longer
      ...
      <div className="w-full md:gap-3 gap-8 py-10 md:py-20 md:px-14 px-4  flex flex-col md:flex-row">
        <div className="md:w-1/2 w-full flex flex-col gap-2">
          ...
          <p className="font-light text-sm md:text-base">
            We certainly give a termite affected household or office better than
            any other service provider because we have the best knowledge and
            highly qualified workforce in house. Along with this, we use the
            best pesticides and highly progressive infrared technology to finish
            the white ants completely. Normally known as white ants, termites
            are dangerous enough to hollow all the wooden structures of your
            house/workplace.
          </p>
          <p className="font-light mt-2 md:mt-4 text-sm md:text-base">
            ...
            technology and smartly planned procedure to finish the termites from
            root. Our smartly developed and included termite control solutions
            are well-organized enough to solve the problem fully.
          </p>
        </div>
      ...
      <div className="w-full md:gap-3 gap-8 py-10 md:py-20 md:px-14 px-4 flex flex-col md:flex-row ">
        <div className="md:w-1/2 w-full flex flex-col gap-2">
          ...
          <p className="font-light text-sm md:text-base">
            Wood-boring beetles include several peoples of beetles whose larvae
            feed on wood and wood products. A Wood-boring beetle&apos;s play a
            significant ecological role by tunnelling through dead and decaying
            wood to aid in decomposition. Wood borers are wood damaging insect
            that invade and damage structural and furniture wood based on the
            type and moisture content of the wood.
          </p>
      ...
      <div className="w-full md:gap-8 gap-8 md:py-20 md:px-14 px-4 flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 md:mb-0 mb-[4rem] w-full">
          ...
          <p className="font-light text-sm md:text-base">
            ...
            termites. Termite termination processes are one of our utmost vital
            services presented to our customers. We deliver anti termite
            ...
            Construction anti termite treatments is deal out by us with the help
            of chemicals and sprays, whereas in the Pre-Construction phase,
            early safety can be taken by using anti termite resources for
          ...
          <p className="font-light text-sm md:text-base">
            We offer pre- and post- construction anti termite treatment services
            for all types of commercial and residential properties. We know that
            every task is different but they all leave a lot of dust behind. Our
            team knows that you have invested so much time, money and energy in
            your remodeling or building your new office space and we are certain
            that you will want your final performance to be clean and
            beautiful.Treating termites before creation starts can assist you
            defend against possible claims in the future. Construction design
            for several tasks requires safety for termite in their finishing and
            several others request termite free environment.
          </p>
        </div>
      </div>
      <Footer />
