    ...
    <div className={`flex w-full flex-col ${montserrat.className}`}>
      ...
      <div className="px-14 relative border-b ServicesHeight w-full py-20">
        ...
        <div className="absolute px-4 md:px-14 gap-1 w-full md:w-1/2 justify-center inset-0 flex-col flex">
          ...
          <p className="md:font-light py-1 font-normal text-gray-100 md:text-black">
            ...
            specific needs. Don&apos;t let rodents disrupt your life any longer
      ...
      <div className="w-full md:gap-3 gap-8 py-10 md:py-20 md:px-14 px-4  flex flex-col md:flex-row">
        <div className="md:w-1/2 w-full flex flex-col gap-2">
          ...
          <p className="font-light text-sm md:text-base">
            ...
            some air bricks allow mice access to a building. Kitchens tend to be
            highly preferred area for mice to infest therefore is the most
          ...
          <p className="font-light mt-2 md:mt-4 text-sm md:text-base">
            {" "}
            They are considered to be pests due to the fact that they are living
            creatures capable of transmitting deadly diseases like bubonic
            plague, leptospirosis, lymphocytic chorio-meningitis, rat-bite
            fever, salmonella, tapeworms and others. Mice can easily find their
            way into residential and commercial premises, and most likely to be
            prevalent in the areas where food is stored or near areas where
            rubbish is dumped. Their natural and constant gnawing habit means
            mice can also cause great damage to your property, furnishings and
            equipment.
          </p>
        </div>
      ...
      <div className="w-full md:gap-3 gap-8 py-10 md:py-20 md:px-14 px-4 flex flex-col md:flex-row ">
        <div className="md:w-1/2 w-full flex flex-col gap-2">
          ...
          <p className="font-light text-sm md:text-base">
            Mice unlike rats are usually active at night time, most common sign
            of mice infestation are Black colored 3-7mm long droppings, usually
            scattered along the paths they pass through. Also they leave behind
            dark smudge marks that may appear on walls, skirting and other
            surfaces, onto which mice brush their bodies passing through. They
            nibble on doors, skirting, walls or other surfaces. Noises at night
            time of nibbling and scratching also indicates the presence of the
            mice. An unpleasant odour caused by mice urine is also an indication
            of mice infestation.
          </p>
          ...
          <p className="font-light text-sm md:text-base">
            ...
            exclude mice by closing entry access points. Setting mouse traps or
            place mouse bait in the detected areas. Enclose the food in tight
            fitting containers. Kitchen floors, sinks and counter tops need to
            be kept clean. We will help you by arranging our experts to get the
            best inspection done all around the house specially door
            corners,kitchen, down of your furniture&apos;s etc. It will prevent
            the infestation to get more and wide.
          </p>
        </div>
      ...
      <div className="w-full md:gap-8 gap-8 md:py-20 md:px-14 px-4 flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 md:mb-0 mb-[4rem] w-full">
          ...
          <p className="font-light text-sm md:text-base">
            ...
            effect so the place will be protected for an extended period of time
            to ensure mouse extermination.
          </p>
          ...
          <p className="font-light text-sm md:text-base">
            ...
            an infestation. We will also collect and dispose of mouse carcasses
            if there are any at all. Our pest exterminator might even offer you
            some useful advice on how to prevent future mice infestation. RM
            Pestokill London is one of the best pest control services provider.
            We are experts in Mice Removal. All our technicians have years of
            training and are fully qualified. For advice and appointments call
            RM Pestokill Today. We work 7 days a week from 9:30am – 01:30am.Call
            us on 020 8679 3330 or 078 3775 6738
          </p>
        </div>
      </div>
      <div className="px-0 bg-green-800 flex justify-center items-center">
      ...
      <div className="w-full md:gap-3 gap-8 py-10 md:py-20 md:px-14 px-4 flex flex-col md:flex-row ">
        <div className="md:w-1/2 w-full flex flex-col gap-2">
          ...
          <p className="font-light text-sm md:text-base">
            ...
            property, these harmful rodents can usually be found underneath the
            kitchen units, behind bath panels, inside roof voids and sheds and
            in the kitchen garden and garden decking.
          </p>

          <h3 className="text-[1.4rem] mt-8 font-bold">Signs</h3>
          <p className="font-light text-sm md:text-base">
            Usual signs of the rat infestation are gnawed electrical wires, half
            chewed cereals or foods, nibbled plastic or even mild steel. At RM
            Pestokill we make sure that our technicians apply humane rat control
            methods authorized by necessary bodies governed by rat control UK.
            We use techniques that are not at all harmful to children or pets.
            We usually use taper proof plastic bait boxes and place them at
            strategic points in the premises in order to exterminate the
      ...
      <div className="w-full md:gap-8 gap-8 md:py-20 md:px-14 px-4 flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 md:mb-0 mb-[4rem] w-full">
          ...
          <p className="font-light text-sm md:text-base">
            If you have seen evidence of rats or want to help protect your home
            against rats, our team will inspect your home. We will very
          ...
          <p className="font-light text-sm md:text-base">
            ...
            points. Our certified technician will initially survey the property
            to find the activity areas and the entry points. They will then
            block up the holes and apply a treatment to get rid of the problem
          ...
          <p className="font-light text-sm md:text-base">
            ...
            suspicious, we will investigate on it. Our technician will offer you
            some great advice on how to protect your property from rats in the
            future. For FREE advice and appointments call RM Pestokill Today. We
            work 7 days a week from 9:30am – 01:30am.Call us on 020 8679 3330 or
            078 3775 6738
          </p>
        </div>
      </div>
