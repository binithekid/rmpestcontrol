  ...
  return (
    <>
      <Head>
        ...
        />
        <title>Cockroach Pest Control | RM Pest Control</title>
      </Head>
        ...
        <div className="w-full md:gap-3 gap-8 py-10 md:py-20 md:px-14 px-4  flex flex-col md:flex-row">
          <div className="md:w-1/2 w-full flex flex-col gap-2">
            ...
            <p className="font-light mt-2 md:mt-4 text-sm md:text-base">
              ...
              poison mixed in with an attractive food. It would also help for
              you to move yard debris away from the outside of the house.
              Cockroaches are usually nocturnal but where there is a heavy
              infestation you will often see them in the daytime. Their
              droppings will often be found wherever there is suitable food and
              will look similar to black pepper granules. A strong sour smell is
              often noticeable where there is a particularly heavy infestation
              and professional treatment is often needed to put an end to the
              problem.{" "}
            </p>
          </div>
        ...
        <div className="w-full md:gap-3 gap-8 py-10 md:py-20 md:px-14 px-4 flex flex-col md:flex-row ">
          <div className="md:w-1/2 w-full flex flex-col gap-2">
            ...
            <p className="font-light text-sm md:text-base">
              ...
              and droppings everywhere they go. A cockroach infestation produces
              a lingering and unpleasant odour that taints items they contact.
            </p>
            ...
            <p className="font-light text-sm md:text-base">
              ...
              specialists are professionally trained and will look all around
              your property . Our pest control technicians can also deploy traps
              such as glue boards in areas where cockroaches may travel or hide.
            </p>
          </div>
        ...
        <div className="w-full md:gap-8 gap-8 md:py-20 md:px-14 px-4 flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 md:mb-0 mb-[4rem] w-full">
            ...
            <p className="font-light text-sm md:text-base">
              ...
              and fogging and extremely effective professional food substitute
              gels. This makes the treatments extremely effective. All our field
            ...
            <p className="font-light text-sm md:text-base">
              ...
              even offer you some useful advice on how to avoid cockroach
