    ...
    <div className={`flex w-full flex-col ${montserrat.className}`}>
      ...
      <div className="w-full md:gap-3 gap-8 py-10 md:py-20 md:px-14 px-4  flex flex-col md:flex-row">
        <div className="md:w-1/2 w-full flex flex-col gap-2">
          ...
          <p className="font-light text-sm md:text-base">
            Mosquito free world is a movement and long term objective of Indian
            Pest control, to help all parts of nations for Mosquito Control.
            Most often it&apos;s accomplished following concept.
          </p>
          <p className="font-light mt-2 md:mt-4 text-sm md:text-base">
            ...
            strategies that are practical and effective to protect public health
            and the environment and improve the quality of life.
          </p>
          <p className="font-light mt-2 md:mt-4 text-sm md:text-base">
            {" "}
            ...
            biological control. However, helpful data is anecdotal and there is
            no documented study to show that bats, purple martins, or other
      ...
      <div className="w-full md:gap-3 gap-8 py-10 md:py-20 md:px-14 px-4 flex flex-col md:flex-row ">
        <div className="md:w-1/2 w-full flex flex-col gap-2">
          ...
          <p className="font-light text-sm md:text-base">
            Mosquito fogging operations will have some success in killing adult
            mosquitoes in the parts that are preserved, the residents of Honiara
            and GP are cautioned that this activity alone is not plenty to
            defend everyone or prevent all dengue infections. To decrease and
            control dengue outbreaks a number of actions essential to be taken
            not only by public authorities but also by residents.
          </p>

          <p className="font-light mt-2 md:mt-4 text-sm md:text-base">
            These include making assured there are no dengue mosquitoes breeding
            in your yard, such as in tyres, drums, buckets and any water storage
            containers, and that you also keep safe your family from mosquito
            bites inside and outside the house during the day and in the early
            morning and early evening. The best procedures of personal
            protection are to apply insect repellent and to wear long sleeves
            and long pants.
          </p>
        </div>
