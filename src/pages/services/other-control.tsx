    ...
    <div className={`flex w-full flex-col ${montserrat.className}`}>
      ...
      <div className="px-14 relative border-b ServicesHeight w-full py-20">
        ...
        <div className="absolute px-4 md:px-14 gap-1 w-full md:w-1/2 justify-center inset-0 flex-col flex">
          ...
          <p className="md:font-light py-1 font-normal text-gray-100 md:text-black">
            ...
            effectively eliminating pest infestations, tailored to your specific
            needs. Don&apos;t let pests disrupt your life any longer – contact
            us today for a consultation and take back control of your space.
          </p>
      ...
      <div className="w-full md:gap-3 gap-8 py-10 md:py-20 md:px-14 px-4  flex flex-col md:flex-row">
        <div className="md:w-1/2 w-full flex flex-col gap-2">
          ...
          <p className="font-light text-sm md:text-base">
            ...
            It is estimated that there are more than 20,000 of ant species. They
            are small, black or reddish brown in color. They are attracted to
            anything sugary or oily and also get attracted to heated areas like
            boilers, kitchens, laundries, central heating pipes, radiators, etc.
          </p>
          ...
          <p className="font-light mt-2 md:mt-4 text-sm md:text-base">
            {" "}
            Garden ants can normally be eradicated by using insecticides in the
            form of dust powder or sprays directly to the nest site, but the
            case is not same for in house infestation as it is hard to locate
            their nests and trails. Professionals at RM Pestokill are
      ...
      <div className="w-full md:gap-3 gap-8 py-10 md:py-20 md:px-14 px-4 flex flex-col md:flex-row ">
        <div className="md:w-1/2 w-full flex flex-col gap-2">
          ...
          <p className="font-light text-sm md:text-base">
            {" "}
            Any stock damage can be the first sign of Moths presence inside the
            premises. They usually lay their eggs within the food product for
            their newborn larvae to feed upon once hatched.
          </p>
          <p className="font-light text-sm md:text-base">
            {" "}
            Our team of experts on initial inspection looks for the hotspots of
            the insect activity within the given area to understand the estimate
            size of the infestation, identify the type of insect, study their
            breeding cycles and feeding habits, this will help us to formulate
            the best action plan to get rid of the infestation.
          </p>
          <p className="font-light text-sm md:text-base">
            {" "}
            <span className="font-semibold">Beetles:</span> Larder beetles,
            grain weevils, saw tooth grain beetle, flour beetle, biscuit beetle,
            yellow meal worm beetle and spider beetles.
          </p>
          <p className="font-light text-sm md:text-base">
            {" "}
            <span className="font-semibold">Moths:</span> Mill moth, Indian meal
            moth and the tropical warehouse moth are the most common type moths.
            There are many more insect’s which infest stored products but those
            mentioned tend to show up more regularly and appear more wide
            spread.
          </p>
          <p className="font-light text-sm md:text-base">
            {" "}
      ...
      <div className="w-full md:gap-8 gap-8 md:py-20 md:px-14 px-4 flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 w-full">
          ...
          <p className="font-light md:mt-4 mt-2 text-sm md:text-base">
            ...
            sometime don’t even spare humans. Fleas when infest humans may cause
            huge amount of distress not due to their bites only but also due to
            the spikes on their legs that gives stinging sensation.
          </p>
          <p className="font-light md:mt-4 mt-2 text-sm md:text-base">
          ...
          <p className="font-light md:mt-4 mt-2 text-sm md:text-base">
            ...
            around so that we may tailor a problem specific solution in order to
            get rid of the fleas and stop them from breeding further.
          </p>
          <h3 className="text-[1.4rem] mt-8 font-bold">Wasps</h3>
          <p className="font-light text-sm md:text-base">
            These scary summertime creatures can cause havoc to your summer
            enjoyment. Usually categorized as paper wasp, yellow jacket wasp or
            bald headed wasp, they usually build their nest under concrete
            floor, inside air vents, in roofs, in trees or even on the outside
            wall of your garden.
          </p>{" "}
          <p className="font-light mt-8 text-sm md:text-base">
            Wasp bites are quite painful and if gets access to kitchen may cause
            contamination of food as well. Therefore it is suggested that if you
            notice them buzzing around inside your premises, take it as the
            first sign of wasp infestation. We therefore suggest for
      ...
      <div className="w-full md:gap-3 gap-8 mb-5 py-10 md:px-14 px-4 flex flex-col-reverse md:flex-row ">
        <div className="md:w-1/2 w-full flex flex-col gap-2">
          ...
          <p className="font-light text-sm md:text-base">
            ...
            innovative methodology making use of quality approved chemicals and
            pesticides which are helping in eradicating pests from the garden.
            An insecticide perimeter treatment helps as a first line of defense
            around your home, stopping pests before they enter.
          </p>
          <p className="font-light text-sm md:text-base">
            {" "}
            ...
            boulder bugs, stink bugs, and Asian lady beetles. Susceptibility of
            a garden to pests is one of the biggest problems faced by most of
            the gardeners. However there are some techniques that discourage
            their presence at the first place, yet there is treatment for pest
            control once they appear in your garden area.
          </p>
          ...
          <p className="font-light text-sm md:text-base">
            ...
            protein/grease based foods. Once they find a food source, ants will
            leave a pheromone trail for other ants to follow.
          </p>{" "}
        </div>
        <div className="md:w-1/2 md:pl-8 w-full flex">
          <Image
