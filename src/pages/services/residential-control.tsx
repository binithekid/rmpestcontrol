    ...
    <div className={`flex w-full flex-col ${montserrat.className}`}>
      ...
      <div className="px-14 relative border-b ServicesHeight w-full py-20">
        <div
          ...
          style={{
            backgroundImage: "url(/residentialbackground.jpeg)",
          }}
        />
      ...
      <div className="w-full md:gap-3 gap-8 py-10 md:py-20 md:px-14 px-4  flex flex-col md:flex-row">
        <div className="md:w-1/2 w-full flex flex-col gap-2">
          <h3 className="text-[1.4rem] font-bold">Residential Pest Control</h3>
          <p className="font-light text-sm md:text-base">
            Residential Pest Control Services consists of treating your home
            both inside and outside if required to shield your home against its
            exclusive pest invaders. Our Pest Control Services are effective and
            cost efficient and you will be supported by our friendly and
            licensed service technicians who will comprehensively and thoroughly
            review your home and yard to find out potential issue. Then we will
            offer you with a totally custom-made prospectus to treat and remove
            entry points and nests of the pest. We deal with the entire
            elimination of pests and insects in line with affordable and
            custom-made resolutions
          </p>
        </div>
